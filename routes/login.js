...
// Set up middleware
router.use(session({ secret: process.env.session_secret, saveUninitialized: true, resave: true, store: MongoDBStore.create({ mongoUrl: process.env.MONGO_URI, dbName: 'tmtm', collectionName: 'sessions' }) }));
